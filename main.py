...
def main():
    ...
    class DragImg:
        def _init_(self, path, posOrigin, imgType):
    ...
    for x, pathImg in enumerate(myList):
        if 'png' in pathImg:
            ...
            imgType = 'jpg'
        listImg.append(DragImg(f'{path}/{pathImg}', [50 + x * 50, 50], imgType))
    ...
    while True:
        ...
        display_width = 1280  # Adjust this to your desired display width
        display_height = 720  # Adjust this to your desired display height
